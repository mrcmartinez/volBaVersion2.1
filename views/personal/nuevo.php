        ...
        <div class="center-form">
            ...
            <form class="row g-3" action="<?php echo constant('URL'); ?>personal/registrarPersonal" method="POST">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control" type="text" name="colonia" id="" autocomplete="off" required>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="estado_civil" name="estado_civil" autocomplete="off">
                ...
                <div class="col-md-2">
                    ...
                    <select class="form-select" id="turno" name="turno" autocomplete="off">
                ...
                <div class="col-md-12">
                    <label for=""> </label>
                    <input class="form-control btn btn-dark" type="submit" value="Registrar" autocomplete="off">
                </div>
                <div class="col-md-12">
